  ...
  <section className="prestataire">
    <div className="prestataire__top">
      ...
      <div className="prestataire__top__buttons">
        <button className="prestataire__top__buttons--button" type="button">Nous Contactez</button>
        <button className="prestataire__top__buttons--fav" type="button">♡</button>
      </div>
    </div>
    <div className="prestataire__carousel">
      <CarouselItem />
    </div>
    <div className="prestataire__content">
      <div className="prestataire__content__details">
        <h5>Description Fiestamania</h5>
        <p>
      ...
      <div className="prestataire__content__infos">
        <p className="prestataire__content__infos--label">Adresse :</p>
        <p className="prestataire__content__infos--content">Centre ville 75000 Paris (Paris)</p>
        <p className="prestataire__content__infos--label">Prix :</p>
        <p className="prestataire__content__infos--content">Tarif à partir de 650€</p>
        <p className="prestataire__content__infos--label">Minimun invités :</p>
        <p className="prestataire__content__infos--content">10</p>
        <p className="prestataire__content__infos--label">Maimun invités :</p>
        <p className="prestataire__content__infos--content">5000</p>
      </div>
    </div>
  </section>
);
